...
pub fn test() {
    ...
    test.get_mut_or(Id::new("NOOOO"), Box::new(666i32));

    println!("{:#?}", test.get_mut::<i32>(Id::new("Bruh")));
    println!("{:#?}", test.get_mut::<VecI2>(Id::new("Nice")));
    println!("{:#?}", test.get_mut::<Box<i32>>(Id::new("NOOOO")));
}
